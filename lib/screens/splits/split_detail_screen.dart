...
class _SplitDetailScreenState extends State<SplitDetailScreen> {
                ...
                children: [
                  ...
                  Expanded(
                    child: ElevatedButton(
                      onPressed: () {
                        final amount = double.tryParse(_settlementAmountController.text) ?? 0.0;
  ...
  Future<void> _settleUp(String participantId, double amount) async {
    ...
    try {
      await context.read<GroupService>().addSettlement(widget.split.id, settlement);
              ...
              child: Column(
                ...
                children: [
                      ...
                      decoration: BoxDecoration(
                        gradient: LinearGradient(
                          colors: isGroupSplit 
                              ...
                              : [const Color(0xFFFF7F50), Colors.deepOrange],
                      ...
                      child: Column(
                        children: [
                          ...
                          Container(
                            ...
                            child: Text(
                              widget.split.splitType == SplitType.equal ? 'Equal Split' : 'Unequal Split',
                              style: const TextStyle(
                                color: Colors.white,
                  ...
                  _buildDetailCard([
                    ...
                    _buildDetailRow('Date', DateFormat('EEEE, MMMM d, y').format(widget.split.createdAt)),
                    _buildDetailRow('Time', DateFormat('h:mm a').format(widget.split.createdAt)),
                    if (widget.split.description.isNotEmpty)
                      _buildDetailRow('Description', widget.split.description),
                    if (widget.split.notes.isNotEmpty)
                      _buildDetailRow('Notes', widget.split.notes),
                    _buildDetailRow('Status', widget.split.isFullySettled ? 'Fully Settled' : 'Pending'),
                  ]),
                  ...
                  ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (!isPayer && !isCurrentUser && currentUserId != widget.split.paidBy) {
                        return const SizedBox.shrink();
                      }
                      
                      final amountOwed = widget.split.getAmountOwedBy(participantId);
                      final amountSettled = widget.split.getTotalSettledAmount(participantId);
                      final remainingAmount = widget.split.getRemainingAmount(participantId);
                  ...
                  // Tags
                  if (widget.split.tags.isNotEmpty) ...[
                    const Text(
                      'Tags',
                      style: TextStyle(
                        fontSize: 18,
                    ...
                    Wrap(
                      spacing: 8,
                      runSpacing: 8,
                      children: widget.split.tags.map((tag) {
                        return Container(
          ...
          children: [
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Text(
                    isCurrentUser ? 'You' : 'Friend', // Replace with actual name in real app
                    style: const TextStyle(
                      fontWeight: FontWeight.bold,
                      fontSize: 16,
                    ),
            ...
            if (!isPayer && remainingAmount > 0 && 
              ...
              ElevatedButton(
                onPressed: () => _showSettleUpDialog(participantId, remainingAmount),
                style: ElevatedButton.styleFrom(
                  backgroundColor: const Color(0xFF008080),
                  foregroundColor: Colors.white,
                  shape: RoundedRectangleBorder(
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    DateFormat('MMM d, y • h:mm a').format(settlement.settledAt),
                    style: TextStyle(
                      fontSize: 12,
                      color: Colors.grey[600],
                    ),
